...
class SmallWindow(AbstractPractice):
    """Play ideas over chords"""

    _TITLE = "Small window"
    _SUBTITLE = "Play in a small window"
    _MAX_CHORDS = 4
    ...
    def get_exercise(self, quantity: int, guitar: dict) -> exercise.Exercise:
        ...
        while len(random_steps) < quantity:
            ...
            random_step = exercise_step.ExerciseStep("Melody", random_chord_txt)
